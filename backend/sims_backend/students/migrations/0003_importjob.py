    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "invalid_rows",
                    models.PositiveIntegerField(default=0, help_text="Number of invalid rows with errors"),
                ),
                (
                    "created_count",
                    models.PositiveIntegerField(default=0, help_text="Number of students created during commit"),
                ),
                (
                    "updated_count",
                    models.PositiveIntegerField(
                ...
                (
                    "failed_count",
                    models.PositiveIntegerField(default=0, help_text="Number of rows that failed during commit"),
                ),
                (
                    "error_report_file",
                    models.FileField(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["created_by"], name="students_im_created_a24243_idx"),
                ],
            },
        ),
    ]
