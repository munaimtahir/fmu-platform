    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "force_approve",
                    models.BooleanField(default=False, help_text="Admin-only override to bypass duplicate checks"),
                ),
                ...
                (
                    "cnic_or_bform",
                    models.CharField(db_index=True, help_text="CNIC or B-Form number (normalized)", max_length=20),
                ),
                ...
                (
                    ...
                    models.CharField(help_text="Guardian WhatsApp number (required)", max_length=20),
                ),
                (
                    "mdcat_roll_number",
                    models.CharField(
                        db_index=True, help_text="MDCAT Roll Number (required, checked for duplicates)", max_length=50
                    ),
                ),
                (
                    "merit_number",
                    models.IntegerField(
                        help_text="Merit number (must be > 0)", validators=[django.core.validators.MinValueValidator(1)]
                    ),
                ),
                (
                    "merit_percentage",
                ...
                (
                    "last_qualification",
                    models.CharField(
                        choices=[("MATRIC", "Matric"), ("FSC", "FSc"), ("A_LEVELS", "A-Levels"), ("OTHER", "Other")],
                        max_length=20,
                    ),
                ),
                ...
                (
                    "passport_size_photo",
                    models.ImageField(
                        help_text="Passport-size photograph (jpg/png only, max 1MB, REQUIRED)", upload_to="intake/"
                    ),
                ),
                (
                    "cnic_front",
