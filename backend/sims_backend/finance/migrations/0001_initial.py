    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Human readable fee type name", max_length=128),
                ),
                (
                    "is_active",
                    models.BooleanField(default=True, help_text="Whether this fee type can be used"),
                ),
            ],
            options={
                "ordering": ["code"],
                "indexes": [models.Index(fields=["is_active"], name="finance_fee_is_acti_c3891d_idx")],
            },
        ),
        migrations.CreateModel(
            name="FinancePolicy",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "voucher_no",
                    models.CharField(help_text="Readable voucher number", max_length=64, unique=True),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "entry_type",
                    models.CharField(choices=[("debit", "Debit"), ("credit", "Credit")], max_length=8),
                ),
                (
                    "amount",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_mandatory",
                    models.BooleanField(default=True, help_text="Whether this fee is mandatory"),
                ),
                (
                    "frequency",
                    models.CharField(
                ...
                (
                    "effective_from",
                    models.DateField(blank=True, help_text="Optional effective start date", null=True),
                ),
                ("is_active", models.BooleanField(default=True)),
                (
                    "program",
        ...
        migrations.AddIndex(
            model_name="voucher",
            index=models.Index(fields=["student", "term"], name="finance_vou_student_cf277a_idx"),
        ),
        migrations.AddIndex(
            model_name="voucher",
        ...
        migrations.AddIndex(
            model_name="payment",
            index=models.Index(fields=["student", "term"], name="finance_pay_student_c464aa_idx"),
        ),
        migrations.AddIndex(
            model_name="payment",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["student", "term"], name="finance_led_student_0dbde9_idx"),
        ),
        migrations.AddIndex(
            model_name="ledgerentry",
            index=models.Index(
