    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group",
                    models.ForeignKey(
                        help_text="Group this timetable is for",
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="weekly_timetables",
                        to="academics.group",
                    ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["academic_period", "group", "week_start_date"], name="timetable_w_academi_abc123_idx"
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "line1",
                    models.CharField(
                        blank=True, help_text="First line of cell content (e.g., course name)", max_length=200
                    ),
                ),
                (
                    "line2",
                    models.CharField(
                        blank=True, help_text="Second line of cell content (e.g., room number)", max_length=200
                    ),
                ),
                (
                    "line3",
                    models.CharField(
                        blank=True, help_text="Third line of cell content (e.g., faculty name)", max_length=200
                    ),
                ),
                (
                    "weekly_timetable",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["weekly_timetable", "day_of_week", "time_slot"], name="timetable_t_weekly__jkl012_idx"
                    ),
                ],
            },
        ),
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=["group", "week_start_date"], name="unique_weekly_timetable_per_group_week"
            ),
        ),
        migrations.AddConstraint(
