...
# Initial migration for people app
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(help_text="First/given name", max_length=100),
                ),
                (
                    "middle_name",
                    models.CharField(
                ...
                (
                    "last_name",
                    models.CharField(help_text="Last/family name", max_length=100),
                ),
                (
                    "date_of_birth",
                    models.DateField(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["person", "type"],
                        name="people_contact_person_9a7b2c_idx",
                    ),
                    models.Index(
                        fields=["type", "value"],
                        name="people_contact_type_va_7d8e9f_idx",
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["person", "type"],
                        name="people_address_person_3c4d5e_idx",
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document_number",
                    models.CharField(help_text="Document number", max_length=100),
                ),
                (
                    "issue_date",
                    models.DateField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["person", "type"],
                        name="people_identity_person_6f7g8h_idx",
                    ),
                    models.Index(
                        fields=["document_number"],
                        name="people_identity_documen_9i0j1k_idx",
                    ),
                ],
