...
class Student(TimeStampedModel):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(Lower("reg_no"), name="student_reg_no_case_insensitive_unique"),
        ]

    def __str__(self) -> str:
        return f"{self.reg_no} - {self.display_name} ({self.program.name}, {self.batch.name})"
