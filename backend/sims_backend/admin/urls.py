...
urlpatterns = [
    ...
    path("api/admin/impersonation/start/", start_impersonation, name="impersonation-start"),
    path("api/admin/impersonation/stop/", stop_impersonation, name="impersonation-stop"),
