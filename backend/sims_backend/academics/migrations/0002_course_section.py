    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        help_text="Course code (e.g., 'ANAT-101', 'PHYS-201')", max_length=32, unique=True
                    ),
                ),
                (
                    "name",
                    models.CharField(help_text="Course name (e.g., 'Human Anatomy', 'Physiology')", max_length=255),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Section name (e.g., 'Section A', 'Morning Batch')", max_length=128),
                ),
