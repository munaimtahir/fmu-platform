...
class StudentIntakeSubmissionTest(TestCase):
    ...
    def setUp(self):
        ...
        self.test_image = SimpleUploadedFile("test_photo.jpg", b"fake image content", content_type="image/jpeg")
    ...
    def test_public_submission_creates_pending_record(self):
        ...
        files = {"passport_size_photo": self.test_image}

        response = self.client.post("/apply/student-intake/", {**self.form_data, **files})
    ...
    def test_duplicate_mdcat_roll_number_blocks_approval(self):
        ...
        self.assertIn(
            "MDCAT123", [s for s in duplicates["mdcat"] if "STU-20240101-0001" in s or "STU-20240101-0001" == s]
        )
