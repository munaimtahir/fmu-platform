    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        blank=True, help_text="Department code (e.g., 'ANAT', 'MED')", max_length=32, unique=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Program name (e.g., MBBS, BDS, MD, etc.)", max_length=128, unique=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period_type",
                    models.CharField(
                        choices=[("YEAR", "Year"), ("BLOCK", "Block"), ("MODULE", "Module")],
                ...
                (
                    "name",
                    models.CharField(help_text="Period name (e.g., 'Year 1', 'Block 1', 'Module A')", max_length=128),
                ),
