    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "ordering": ["starts_at"],
                "indexes": [
                    models.Index(fields=["academic_period", "group"], name="timetable_s_academi_013887_idx"),
                    models.Index(fields=["faculty"], name="timetable_s_faculty_a5b647_idx"),
                    models.Index(fields=["starts_at"], name="timetable_s_starts__86be5c_idx"),
                ],
            },
        ),
    ]
