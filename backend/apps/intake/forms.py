...
class StudentIntakeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "guardian_relation": forms.Select(
                attrs={
                    "class": "form-control",
                    "required": True,
                }
            ),
            "guardian_phone_whatsapp": forms.TextInput(
                attrs={
                    "type": "tel",
                    "class": "form-control",
                    "required": True,
            ...
            "mdcat_roll_number": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "required": True,
                }
            ),
            "merit_number": forms.NumberInput(
                attrs={
                    "class": "form-control",
                    "min": 1,
                    "required": True,
            ...
            "merit_percentage": forms.NumberInput(
                attrs={
                    "class": "form-control",
                    "step": "0.01",
                    "min": 0,
            ...
            "last_qualification": forms.Select(
                attrs={
                    "class": "form-control",
                    "required": True,
                }
            ...
            "board_or_university": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "required": True,
                }
            ...
            "total_marks_or_grade": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "required": True,
                }
            ),
            "obtained_marks_or_grade": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "required": True,
                }
            ...
            "passport_size_photo": forms.FileInput(
                attrs={
                    "class": "form-control",
            ...
            "cnic_front": forms.FileInput(
                attrs={
                    "class": "form-control",
                    "accept": ".pdf,.jpg,.jpeg,.png",
                }
            ),
            "cnic_back": forms.FileInput(
                attrs={
                    "class": "form-control",
                    "accept": ".pdf,.jpg,.jpeg,.png",
                }
            ),
            "domicile": forms.FileInput(
                attrs={
                    "class": "form-control",
                    "accept": ".pdf,.jpg,.jpeg,.png",
                }
            ),
            "matric_certificate": forms.FileInput(
                attrs={
                    "class": "form-control",
                    "accept": ".pdf,.jpg,.jpeg,.png",
                }
            ),
            "fsc_certificate": forms.FileInput(
                attrs={
                    "class": "form-control",
                    "accept": ".pdf,.jpg,.jpeg,.png",
                }
            ),
            "migration_certificate": forms.FileInput(
                attrs={
                    "class": "form-control",
                    "accept": ".pdf,.jpg,.jpeg,.png",
                }
            ),
            "other_document_1": forms.FileInput(
                attrs={
                    "class": "form-control",
                    "accept": ".pdf,.jpg,.jpeg,.png",
                }
            ),
            "other_document_2": forms.FileInput(
                attrs={
                    "class": "form-control",
                    "accept": ".pdf,.jpg,.jpeg,.png",
                }
